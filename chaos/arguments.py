...
def vis_argparser():
    ...
    pconfig.add_argument(
        ...
        Default is None.""")
    pconfig.add_argument(
        "-lf", "--logfile", dest="logfiles", nargs='+', type=str, metavar="",
        default=None,
    ...
    pconfig.add_argument(
        "-o", "--htmlname", dest="html_naes", nargs='+', type=str, metavar='',
        default=None,
    ...
    d_config.add_argument(
        "--taql", dest="taql", nargs='+', type=str, metavar='', default=None,
        help="TAQL where")
    d_config.add_argument(
