...
def vis_argparser():
    ...
    pconfig.add_argument("--cmap", dest="cmaps", type=str, metavar='',
                        ...
                        is blue. """,
                         default=None)
    pconfig.add_argument("--cols", dest="grid_cols", nargs='+', type=int, metavar='',
                         help="""Number of columns in grid if iteration is
                         active. Default is 9.""",
                         default=None)
    pconfig.add_argument("-ca", "--colour-axis", dest="c_axes", nargs='+', type=str,
                         metavar='',
    ...
    pconfig.add_argument("-ia", "--iter-axis", dest="i_axes", nargs='+', type=str,
                         metavar='', choices=iter_choices,
                         help="""Select column to iterate over. This will
                        result in a grid. Default is None.""",
                         default=None)
    pconfig.add_argument("-lf", "--logfile", dest="logfiles", nargs='+', type=str,
                         metavar="",
    ...
    pconfig.add_argument("-lp", "--link-plots", dest="link_plots",
                        ...
                        disabled by default""")
    pconfig.add_argument("-o", "--htmlname", dest="html_naes", nargs='+', type=str,
                         metavar='',
                         help="Output HTML file name (without '.html')",
                         default=None)

    d_config = parser.add_argument_group("Data Selection")
    d_config.add_argument("-a", "--ant", dest="antennas", nargs='+', type=str,
                          metavar='',
                        ...
                        Default is all.""",
                          default=None)
    d_config.add_argument("--chan", dest="channels", nargs='+', type=str, metavar='',
                        ...
                        Default is all.""",
                          default=None)
    d_config.add_argument("-c", "--corr", dest="corrs", nargs='+', type=str, metavar='',
                        ...
                        diagonal correlations. Default is all.""",
                          default=None)
    d_config.add_argument("-dc", "--data-column", dest="data_columns", nargs='+',
                          type=str, metavar='',
                          help="""MS column to use for data.
                          Default is DATA.""", default="DATA")
    d_config.add_argument("--ddid", dest="ddids", nargs='+', type=str,
                          metavar='',
                        ...
                        Default is all.""",
                          default=None)
    d_config.add_argument("-f", "--field", dest="fields", nargs='+', type=str,
                          metavar='',
    ...
    d_config.add_argument("-s", "--scan", dest="scans", nargs='+', type=str, metavar='',
                          help="Scan Number to select. Default is all.",
                          default=None)
    d_config.add_argument("--taql", dest="taql", nargs='+', type=str, metavar='',
    ...
    avconfig.add_argument("--cbin", dest="cbins", nargs='+', type=int, metavar="",
                          help="""Size of channel bins over which to average
                        .e.g setting this to 50 will average over every 5
                        channels""",
                          default=None)
    avconfig.add_argument("--tbin", dest="tbins", nargs='+', type=float, metavar='',
    ...
    r_config.add_argument("-cs", "--chunks", dest="chunk_size", type=str,
                          metavar='',
    ...
    r_config.add_argument("-ml", "--mem-limit", dest="mem_limit",
                         ...
                         Default is 1GB""")
    r_config.add_argument("-nc", "--num-cores", dest="ncores", type=int,
                          metavar='',
...
def gains_argparser():
    ...
    parser.add_argument("-v", "--version", action="version",
                        version=f"ragavi {__version__}")
    required = parser.add_argument_group("Required arguments")
    required.add_argument("-t", "--table", dest="msnames",
                          nargs='+', type=str, metavar='',
    ...
    d_config.add_argument("-a", "--ant", dest="antennas", nargs='+', type=str,
                        ...
                        comma-separated list of antennas. Defaults to all.""",
                          default=[None])
    d_config.add_argument("-b", "--baseline", dest="baselines", nargs='+', type=str,
                          metavar='',
                          help="""Plot only a specific antenna, or
                        comma-separated list of antennas. Defaults to all.""",
                          default=[None])
    d_config.add_argument("-chan", "--channel", dest="channels", type=str, metavar='',
                          nargs='+',
                          help="""Channels to include. Defaults to all.""",
                          default=[None])
    d_config.add_argument("-c", "--corr", dest="corrs", type=str, metavar='',
                          nargs='+',
                          help="""Correlation index to plot. Can be a single
                        integer or comma separated integers e.g '0,2'.
                        Defaults to all.""",
                          default=[None])
    d_config.add_argument("--ddid", dest="ddids", type=str, metavar='', nargs='+',
    ...
    d_config.add_argument("-f", "--field", dest="fields", type=str, nargs='+',
                        ...
                        Defaults to all""",
                          default=[None])
    d_config.add_argument("--t0", dest="t0s", nargs='+', type=float, metavar='',
                          help="""Minimum time to plot [in seconds].
                        Defaults to full range]""",
                          default=[None])
    d_config.add_argument("--t1", dest="t1s", nargs='+', type=float, metavar='',
                          help="""Maximum time to plot [in seconds].
                        Defaults to full range""",
                          default=[None])
    d_config.add_argument("--taql", dest="taqls", nargs='+',type=str, metavar='',
                          help="TAQL where clause",
                          default=[None])

    pconfig = parser.add_argument_group("Plot settings")
    pconfig.add_argument("--cmap", dest="cmaps", nargs='+', type=str, metavar='',
    ...
    pconfig.add_argument("-y", "--yaxis", "-d", "--doplot", dest="yaxes",
                         nargs='+', type=str, metavar='',
    ...
    pconfig.add_argument("--debug", dest="debug",
                         action="store_true",
                         help="""Enable debug messages""")
    pconfig.add_argument("-x", "--xaxis", dest="xaxes", nargs='+', type=str, metavar='',
    ...
    pconfig.add_argument("-lf", "--logfile", dest="logfile", type=str,
                         ...
                         default log file name is ragavi.log""",
                         default=[None])
    pconfig.add_argument("-o", "--htmlname", dest="html_names", nargs='+', type=str,
                         metavar='',
                         help="""Name of the resulting HTML file. The '.html'
                        prefix will be appended automatically.""",
                         default=[None])
    pconfig.add_argument("-p", "--plotname", dest="image_names", nargs='+', type=str,
