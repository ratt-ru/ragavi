...
def vis_argparser():
    ...
    parser.add_argument("-ch", "--canvas-height", dest="c_height", type=int,
                        metavar='',
                        help="""Set height resulting image. Note: This is not 
                        the plot height. Default is 720""",
                        default=None)
    ...
    parser.add_argument("-cs", "--chunks", dest="chunks", type=str,
                        metavar='',
                        help="""Chunk sizes to be applied to the dataset. Can
                         be an integer e.g "1000", or a comma separated 
    ...
    parser.add_argument("-ca", "--colour-axis", dest="colour_axis", type=str,
                        ...
                        default=None)
    parser.add_argument("--cols", dest="n_cols", type=int, metavar='',
                        help="""Number of columns if iteration is active.
                        Default is 9.""",
                        default=9)
    ...
    parser.add_argument("-f", "--field", dest="fields", type=str,
                        ...
                        Default is all""",
                        default=None)
    parser.add_argument("-ia", "--iter-axis", dest="iter_axis", type=str,
                        metavar='',
                        choices=iter_choices,
...
def gains_argparser():
    ...
    parser.add_argument("-d", "--doplot", dest="doplot", type=str,
                        metavar='',
                        choices=["ap", "ri"],
                        help="""Plot complex values as amplitude & phase (ap) 
                        or real and imaginary (ri). Defaults to ap.""",
                        default="ap")
    ...
    parser.add_argument("-p", "--plotname", dest="image_name", type=str,
                        metavar='', help="""Static image name. The suffix of this name determines the type of plot. If foo.png, the output will be PNG, else if foo.svg, the output will be of the SVG format.""",
                        default=None)
