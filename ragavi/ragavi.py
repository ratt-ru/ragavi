...
def get_tooltip_data(xds_table_obj, gtype, freqs):
    ...
    freqs : :obj:`np.array`
        An array containing freqs for the current SPW
...
def make_plots(source, fid=0, color="red", yerr=None, yidx=None):
    ...
    y1err : :obj:`numpy.ndarray`, optional
        y1 Error margins for figure `fig` data

    Returns
    -------
    (p1, p1_err): (:obj:`bokeh.models.renderers.GlyphRenderer`, :obj:`bokeh.models.Whisker`,
    :obj:`bokeh.models.renderers.GlyphRenderer`, :obj:`bokeh.models.Whisker`)
    Tuple of containing bokeh.models.renderers.GlyphRenderer with the data glyphs as well as errorbars.
    `p1` : renderer containing data for :obj:`fig`. :obj:`p1_err` outputs from :func:`ragavi.ragavi.errorbar` for :obj:`fig`.
...
def save_static_image(name, figs=None):
    ...
    o_type: :obj:`str`
        Type of static output file. Whether PNG or SVG.
...
def plot_table(**kwargs):
    ...
    k-xaxis: :obj:`str`
        Choose the x-xaxis for the K table. Valid choices are: time or antenna. Defaults to time.
